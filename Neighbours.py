'''
    ...
    предсказать сорт винограда, из которого изготовлено вино, используя результаты химических анализов.
...
while k < 50:
    ...
    classific = KNeighborsClassifier(n_neighbors=k) # классификация метода k ближайших соседей
...
'''
    За счёт приведения признаков к одному масштабу мы получаем оптимальное качество при k > 1. Что достаточно логично
